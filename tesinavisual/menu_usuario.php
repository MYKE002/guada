...
<header>
    <nav class="navbar navbar-expand-lg navbar-primary bg-primary navbar navbar-dark bg-primary">
        <div class="container-fluid"> <a class="navbar-brand" href="#e3f2fd;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                        <a class="nav-link active" href="listado_medico.php">Médicos
                        </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                        <a class="nav-link active" href="cerrar_sesion.php">Cerrar Sesion
                        </a>
                        </li>
                </div>
        </div>
