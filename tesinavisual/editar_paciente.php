...
?>
    ...
    <div class="col-sm-4 offset-sm-4">
        ...
        <form action="guardar_paciente.php" method="post">
            ...
            <H4>
                <th><b><label class="title" for="">EDITAR REGISTRO:</label></b></th>
            </H4>

            <div class="mb-3">
                <th><b><label for="">Cedula:</label></b></th>
                <th><input class="form-control" type="text" name="cedula" id="" value='<?php echo $paciente[1] ?>'></th>
            </div>
            <div class="mb-3">
                <th><b><label for="">Nombre:</label></b></th>
                <th><input class="form-control" type="text" name="nombre_paciente" id="" value='<?php echo $paciente[2] ?>'></th>
            </div>
            <div class="mb-3">
                <th><b><label for="">Edad:</label></b></th>
                <th><input class="form-control" type="number" name="edad" id="" value='<?php echo $paciente[3] ?>'></th>
            </div>
            ...
            <input type="hidden" name="id_paciente" id="" readonly value='<?php echo $paciente[0] ?>'>
